...
<template>
  <Card class="absolute top-0 bottom-0 left-0 right-0 gap-0">
    ...
    <CardContent class="h-full py-0 px-5">
      <ChartContainer :config="chartConfig" class="aspect-auto grow" :cursor="false">
        <VisXYContainer
          :data="filterRange"
          :svg-defs="svgDefs"
          :margin="{ left: -40 }"
